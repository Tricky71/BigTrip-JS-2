...
const createSiteMainTrip = () => {
  return (
    `<section class="trip-main__trip-info  trip-info"></section>`
  )
};

const createSiteMainTripInfo = () => {
  return (
...
render(tripEventsWrapper, createSiteTripDays(), 'beforeend'); 
